...
class Bush(pygame.sprite.Sprite):
    ...
    def __init__(self, group, xpos, ypos):
        ...
        self.image = pygame.image.load(f'./assets/visuals/Bush__0{image_index}.png').convert_alpha()
...
class TombStone(pygame.sprite.Sprite):
    ...
    def __init__(self, group, xpos, ypos):
        ...
        self.image = pygame.image.load(f'./assets/visuals/TombStone__0{image_index}.png').convert_alpha()
...
class Bone(pygame.sprite.Sprite):
    ...
    def __init__(self, group, xpos, ypos):
        ...
        self.image = pygame.image.load(f'./assets/visuals/Bone__0{image_index}.png')
